...
global clientname, CONNECTED, temperature_, pressure_
CONNECTED = False
r = random.randrange(1, 10000000)
clientname = "GARAGE" + str(r)
DHT_topic = 'pr/home/Garage_Temp_Indicator/6317522/sts'
update_rate = 1000  # in msec
# Initial values
temperature_, pressure_ = 20, 205
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self, mc):
        ...
        formLayot.addRow("Pressure", self.Pressure)
...
class MainWindow(QMainWindow):
    ...
    def update_data(self):
        ...
        if temperature_ > 0:
            ...
            temperature_ = 0
        if pressure_ > 0:
            pressure_ = pressure_ + random.randrange(-3, 4)


        # sending data status
        current_data = 'Temperature: ' + str(temperature_) + ' Pressure: ' + str(pressure_)
        self.connectionDock.Temperature.setText(str(temperature_))
        self.connectionDock.Pressure.setText(str(pressure_))
