...
def on_message(client, userdata, msg):
    ...
    pressure = float(m_decode.split(' ')[3])

    if temperature >= temperature_warning or pressure >= pressure_warning:
        ic("WARNING: Temperature too high! Please cool down the garage!")
        send_msg(client, warning_topic, "WARNING: Temperature too high! Please cool down the garage! " + m_decode)
